...
/*
Bahadir: The null check will return true only the first time get() method is called in order to instantiate the private static field and on subsequent calls the same instance will be returned.
 */
